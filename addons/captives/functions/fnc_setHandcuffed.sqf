...
if (_state) then {
    ...
    [_unit, "blockHandRadio", QGVAR(Handcuffed), true] call EFUNC(common,statusEffect_set);
    ...
    [_unit, "blockHandRadio", QGVAR(Handcuffed), false] call EFUNC(common,statusEffect_set);
