...
if (_state) then {
    ...
    [_unit, "blockHandRadio", QGVAR(Surrendered), true] call EFUNC(common,statusEffect_set);
    ...
    [_unit, "blockHandRadio", QGVAR(Surrendered), false] call EFUNC(common,statusEffect_set);
